...
EXTERN_C FUNC VOID PreMain(
  ...
  //
  if ( ( Stardust.Modules.Ntdll = LdrModulePeb( HASH_STRW( L"NTDLL.DLL", 18 ) ) ) ) {
    if ( ! ( Stardust.Win32.RtlAllocateHeap        = LdrFunctionAddr( Stardust.Modules.Ntdll, HASH_STR( "RtlAllocateHeap" ) ) ) ||
